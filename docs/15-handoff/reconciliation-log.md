...
# Reconciliación del contrato

| Versión anterior | Resolución aprobada | Documentos afectados |
|---|---|---|
| «Fase idea» como estado actual | Producto conceptualmente congelado, pre-MVP, Engineering Foundation | README, summary, session, report, handoffs |
...
Reglas existentes conservadas: human commit, versioning, idempotencia, concurrencia optimista, tenancy, estado estructurado, reglas explícitas, no graph/vector DB para MVP, gateway de modelo, research opcional, impacto determinista, IA sin autoridad de commit.
